...
\section*{Input Image}
\textbf{Filename:} \texttt{\detokenize{{{IMAGE_NAME}}}}
...
in steganography and steganalysis research. It consists of 18,000 grayscale images. A second model has also been trained on the residual images
obtained based on the regular dataset.

\textbf{Estimated Stego Confidence:} {{CNN_CONFIDENCE}}

\textbf{Estimated Stego Residual Confidence:} {{CNN_CONFIDENCE_RESIDUAL}}
